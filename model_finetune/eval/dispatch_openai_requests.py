'''
Copied from allenai/open-instruct (Apache-2.0):
https://github.com/allenai/open-instruct/blob/d05effeb4df018dd82c15a956a4a58da82547eb5/eval/dispatch_openai_requests.py
This is the file referenced (but missing) in DS2's eval/utils.py.
'''
'''
